...
for stripe_nb in range(3):
  draw_a_rectangle(left=0, centre_y=15+30*stripe_nb, width=19*13*2, height=15, colour='red')
...
for row in range(7): # there are 9 rows of stars
  ...
  for column in range(stars_qty):
    draw_a_star(centre_x=first_star_centre_x+column*40, centre_y=260-(row+1)*20, radius_1=18, radius_2=6, ends_qty=5, colour='skyblue')               
